...
public class EditCommand extends Command {
    ...
    public static final String MESSAGE_IDENTICAL_EDITED_PERSON = "The edited person must not be identical to the "
            + "original entry";
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        if (personToEdit.equals(editedPerson)) {
            throw new CommandException((MESSAGE_IDENTICAL_EDITED_PERSON));
        }
